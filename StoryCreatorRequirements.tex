...
\begin{itemize}
	\item Actor: The user
		\item Preconditions/Assumptions: At least one object is in the scene and one script is \\
...
\section{Nonfunctional Requirements}
	...
	by first-time or novice user. An experienced user should make no more than 3-5 errors per 			hour. While there is some complexity to the story editor, an expereinced user should not
