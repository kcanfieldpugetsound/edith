...
function loadBlocks(notarray) {
  ...
  for (i = 0; i < array.length; i++) {
    ...
    //loadedBlock.setSize(loadedBlockArray[1].getWidth() + 30, loadedBlockArray[1].getHeight());
 ...
 if (ids === "movD") {
  ...
  if (ids === "addSprite") {
    ...
    for (var i = 0; i < getGlowingObjects().length; i ++) {
      ...
      x = x + oCanvasElement + ", " + getGlowingObjects()[i].attrs.name + ", " + width + ", " + height + ", " + xpos + ", " + ypos + ")\n";
